...
df_standard_raw <- proc_dauers1 %>%
  ...
  dplyr::filter(condition %in% c("20uMascr")) %>%
...
standard_green_merge_K4$class <- factor(standard_green_merge_K4$class, levels=c(1,2,3,4), labels=c("dauer","non-dauer", "other1", "other2"))

standard_green_merge_K4$class <- fct_collapse(standard_green_merge_K4$class, dauer = c("dauer"), nondauer = c("non-dauer", "other1"), other = c("other2"))
...
y_merge_K4_standard_g$class <- factor(y_merge_K4_standard_g$class, levels=c(1,2,3,4), labels=c("dauer","non-dauer", "other1", "other2"))

y_merge_K4_standard_g$class <- fct_collapse(y_merge_K4_standard_g$class, dauer = c("dauer"), nondauer = c("non-dauer", "other1"), other = c("other2"))
...
standard_dauer_assay4_green <- y_merge_K4_standard_g %>% 
  ...
  facet_wrap(c("condition","strain"), ncol = 2, as.table = TRUE, scales = "free_y") +
  #theme_bw() +
  ylim(0, 300) +
  xlim(0, 600)
...
cowplot::ggsave2(standard_dauer_assay4_green, filename = "plots/standard_dauer_assay4_clusters_by_condition_green.png", width = 10, height = 10)
```
...
```{r}
df_24hr_raw_dauers <- easysorter::read_data("data/raw/20220505_dauerProtocol4") # FOR NOW USE THIS ASSAY FOR SETTINGS
