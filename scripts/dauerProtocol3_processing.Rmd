...
## Part 2: Use Daehan's Data to get dauer classes
...
## Part 3: Try to apply those classes to our data
...
# plot to define classes
dauer_assay3_green <- ggplot(y_merge_K4_ours) +
  aes(x = TOF, y = green, scale = T, color = as.factor(class)) +
...
### Looking at red channel
```{r}
z2 <- score_proc[c("TOF","red", "EXT")]

# plot to define classes
dauer_assay3_red <- ggplot(score_proc) +
